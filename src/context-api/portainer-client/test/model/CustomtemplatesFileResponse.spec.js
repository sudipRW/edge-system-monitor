...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomtemplatesFileResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.CustomtemplatesFileResponse();
      });

      it('should create an instance of CustomtemplatesFileResponse', function() {
        // TODO: update the code to test CustomtemplatesFileResponse
        expect(instance).to.be.a(PortainerCeApi.CustomtemplatesFileResponse);
      });
