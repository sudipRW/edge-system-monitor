...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReleaseHookExecution', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ReleaseHookExecution();
      });

      it('should create an instance of ReleaseHookExecution', function() {
        // TODO: update the code to test ReleaseHookExecution
        expect(instance).to.be.a(PortainerCeApi.ReleaseHookExecution);
      });
