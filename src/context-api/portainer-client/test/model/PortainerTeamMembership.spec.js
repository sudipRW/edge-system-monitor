...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerTeamMembership', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerTeamMembership();
      });

      it('should create an instance of PortainerTeamMembership', function() {
        // TODO: update the code to test PortainerTeamMembership
        expect(instance).to.be.a(PortainerCeApi.PortainerTeamMembership);
      });
