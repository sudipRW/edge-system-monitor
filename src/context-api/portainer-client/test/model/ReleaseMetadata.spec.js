...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReleaseMetadata', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ReleaseMetadata();
      });

      it('should create an instance of ReleaseMetadata', function() {
        // TODO: update the code to test ReleaseMetadata
        expect(instance).to.be.a(PortainerCeApi.ReleaseMetadata);
      });
      ...
      it('should have the property kubeVersion (base name: "kubeVersion")', function() {
        // TODO: update the code to test the property kubeVersion
        expect(instance).to.have.property('kubeVersion');
        // expect(instance.kubeVersion).to.be(expectedValueLiteral);
      });

      it('should have the property maintainers (base name: "maintainers")', function() {
        // TODO: update the code to test the property maintainers
        expect(instance).to.have.property('maintainers');
        // expect(instance.maintainers).to.be(expectedValueLiteral);
      });
