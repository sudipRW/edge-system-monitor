...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerRegistryManagementConfiguration', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerRegistryManagementConfiguration();
      });

      it('should create an instance of PortainerRegistryManagementConfiguration', function() {
        // TODO: update the code to test PortainerRegistryManagementConfiguration
        expect(instance).to.be.a(PortainerCeApi.PortainerRegistryManagementConfiguration);
      });
