...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReleaseLock', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ReleaseLock();
      });

      it('should create an instance of ReleaseLock', function() {
        // TODO: update the code to test ReleaseLock
        expect(instance).to.be.a(PortainerCeApi.ReleaseLock);
      });
