...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerTemplateEnvSelect', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerTemplateEnvSelect();
      });

      it('should create an instance of PortainerTemplateEnvSelect', function() {
        // TODO: update the code to test PortainerTemplateEnvSelect
        expect(instance).to.be.a(PortainerCeApi.PortainerTemplateEnvSelect);
      });
