...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndpointsDockerhubStatusResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.EndpointsDockerhubStatusResponse();
      });

      it('should create an instance of EndpointsDockerhubStatusResponse', function() {
        // TODO: update the code to test EndpointsDockerhubStatusResponse
        expect(instance).to.be.a(PortainerCeApi.EndpointsDockerhubStatusResponse);
      });
