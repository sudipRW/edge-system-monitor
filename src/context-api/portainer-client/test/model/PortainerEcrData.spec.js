...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerEcrData', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerEcrData();
      });

      it('should create an instance of PortainerEcrData', function() {
        // TODO: update the code to test PortainerEcrData
        expect(instance).to.be.a(PortainerCeApi.PortainerEcrData);
      });
