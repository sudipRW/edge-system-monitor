...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ImagesImageResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ImagesImageResponse();
      });

      it('should create an instance of ImagesImageResponse', function() {
        // TODO: update the code to test ImagesImageResponse
        expect(instance).to.be.a(PortainerCeApi.ImagesImageResponse);
      });
