...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerKubernetesSnapshot', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerKubernetesSnapshot();
      });

      it('should create an instance of PortainerKubernetesSnapshot', function() {
        // TODO: update the code to test PortainerKubernetesSnapshot
        expect(instance).to.be.a(PortainerCeApi.PortainerKubernetesSnapshot);
      });
