...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReleaseChart', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ReleaseChart();
      });

      it('should create an instance of ReleaseChart', function() {
        // TODO: update the code to test ReleaseChart
        expect(instance).to.be.a(PortainerCeApi.ReleaseChart);
      });
      ...
      it('should have the property lock (base name: "lock")', function() {
        // TODO: update the code to test the property lock
        expect(instance).to.have.property('lock');
        // expect(instance.lock).to.be(expectedValueLiteral);
      });
