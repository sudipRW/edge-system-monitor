...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReleaseReleaseElement', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ReleaseReleaseElement();
      });

      it('should create an instance of ReleaseReleaseElement', function() {
        // TODO: update the code to test ReleaseReleaseElement
        expect(instance).to.be.a(PortainerCeApi.ReleaseReleaseElement);
      });
