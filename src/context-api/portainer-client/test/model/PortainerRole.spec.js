...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerRole', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerRole();
      });

      it('should create an instance of PortainerRole', function() {
        // TODO: update the code to test PortainerRole
        expect(instance).to.be.a(PortainerCeApi.PortainerRole);
      });
