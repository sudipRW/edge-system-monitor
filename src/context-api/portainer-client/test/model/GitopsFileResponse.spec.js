...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GitopsFileResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.GitopsFileResponse();
      });

      it('should create an instance of GitopsFileResponse', function() {
        // TODO: update the code to test GitopsFileResponse
        expect(instance).to.be.a(PortainerCeApi.GitopsFileResponse);
      });
