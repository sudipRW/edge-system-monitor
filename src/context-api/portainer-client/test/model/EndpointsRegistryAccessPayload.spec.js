...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndpointsRegistryAccessPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.EndpointsRegistryAccessPayload();
      });

      it('should create an instance of EndpointsRegistryAccessPayload', function() {
        // TODO: update the code to test EndpointsRegistryAccessPayload
        expect(instance).to.be.a(PortainerCeApi.EndpointsRegistryAccessPayload);
      });
