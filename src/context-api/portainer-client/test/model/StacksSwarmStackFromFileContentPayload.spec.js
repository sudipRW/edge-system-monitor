...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StacksSwarmStackFromFileContentPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.StacksSwarmStackFromFileContentPayload();
      });

      it('should create an instance of StacksSwarmStackFromFileContentPayload', function() {
        // TODO: update the code to test StacksSwarmStackFromFileContentPayload
        expect(instance).to.be.a(PortainerCeApi.StacksSwarmStackFromFileContentPayload);
      });
