...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemNodesCountResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.SystemNodesCountResponse();
      });

      it('should create an instance of SystemNodesCountResponse', function() {
        // TODO: update the code to test SystemNodesCountResponse
        expect(instance).to.be.a(PortainerCeApi.SystemNodesCountResponse);
      });
