...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndpointgroupsEndpointGroupUpdatePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.EndpointgroupsEndpointGroupUpdatePayload();
      });

      it('should create an instance of EndpointgroupsEndpointGroupUpdatePayload', function() {
        // TODO: update the code to test EndpointgroupsEndpointGroupUpdatePayload
        expect(instance).to.be.a(PortainerCeApi.EndpointgroupsEndpointGroupUpdatePayload);
      });
