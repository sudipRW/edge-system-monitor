...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DemoEnvironmentDetails', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.DemoEnvironmentDetails();
      });

      it('should create an instance of DemoEnvironmentDetails', function() {
        // TODO: update the code to test DemoEnvironmentDetails
        expect(instance).to.be.a(PortainerCeApi.DemoEnvironmentDetails);
      });
