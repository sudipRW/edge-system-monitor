...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerWebhook', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerWebhook();
      });

      it('should create an instance of PortainerWebhook', function() {
        // TODO: update the code to test PortainerWebhook
        expect(instance).to.be.a(PortainerCeApi.PortainerWebhook);
      });
