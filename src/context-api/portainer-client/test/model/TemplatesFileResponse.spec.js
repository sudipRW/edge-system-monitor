...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TemplatesFileResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.TemplatesFileResponse();
      });

      it('should create an instance of TemplatesFileResponse', function() {
        // TODO: update the code to test TemplatesFileResponse
        expect(instance).to.be.a(PortainerCeApi.TemplatesFileResponse);
      });
