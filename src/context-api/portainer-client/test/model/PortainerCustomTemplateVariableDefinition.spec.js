...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerCustomTemplateVariableDefinition', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerCustomTemplateVariableDefinition();
      });

      it('should create an instance of PortainerCustomTemplateVariableDefinition', function() {
        // TODO: update the code to test PortainerCustomTemplateVariableDefinition
        expect(instance).to.be.a(PortainerCeApi.PortainerCustomTemplateVariableDefinition);
      });
