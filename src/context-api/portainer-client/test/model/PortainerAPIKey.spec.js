...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerAPIKey', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerAPIKey();
      });

      it('should create an instance of PortainerAPIKey', function() {
        // TODO: update the code to test PortainerAPIKey
        expect(instance).to.be.a(PortainerCeApi.PortainerAPIKey);
      });
