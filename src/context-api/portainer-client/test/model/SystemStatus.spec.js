...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemStatus', function() {
      ...
      it('should have the property demoEnvironment (base name: "demoEnvironment")', function() {
        // TODO: update the code to test the property demoEnvironment
        expect(instance).to.have.property('demoEnvironment');
        // expect(instance.demoEnvironment).to.be(expectedValueLiteral);
      });
