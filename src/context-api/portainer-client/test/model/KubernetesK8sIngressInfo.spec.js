...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesK8sIngressInfo', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.KubernetesK8sIngressInfo();
      });

      it('should create an instance of KubernetesK8sIngressInfo', function() {
        // TODO: update the code to test KubernetesK8sIngressInfo
        expect(instance).to.be.a(PortainerCeApi.KubernetesK8sIngressInfo);
      });
