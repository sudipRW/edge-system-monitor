...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeammembershipsTeamMembershipCreatePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.TeammembershipsTeamMembershipCreatePayload();
      });

      it('should create an instance of TeammembershipsTeamMembershipCreatePayload', function() {
        // TODO: update the code to test TeammembershipsTeamMembershipCreatePayload
        expect(instance).to.be.a(PortainerCeApi.TeammembershipsTeamMembershipCreatePayload);
      });
