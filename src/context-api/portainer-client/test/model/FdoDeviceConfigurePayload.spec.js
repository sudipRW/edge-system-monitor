...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FdoDeviceConfigurePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.FdoDeviceConfigurePayload();
      });

      it('should create an instance of FdoDeviceConfigurePayload', function() {
        // TODO: update the code to test FdoDeviceConfigurePayload
        expect(instance).to.be.a(PortainerCeApi.FdoDeviceConfigurePayload);
      });
