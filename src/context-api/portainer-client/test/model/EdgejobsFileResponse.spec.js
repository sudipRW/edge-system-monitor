...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgejobsFileResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.EdgejobsFileResponse();
      });

      it('should create an instance of EdgejobsFileResponse', function() {
        // TODO: update the code to test EdgejobsFileResponse
        expect(instance).to.be.a(PortainerCeApi.EdgejobsFileResponse);
      });
