...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesK8sIngressController', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.KubernetesK8sIngressController();
      });

      it('should create an instance of KubernetesK8sIngressController', function() {
        // TODO: update the code to test KubernetesK8sIngressController
        expect(instance).to.be.a(PortainerCeApi.KubernetesK8sIngressController);
      });
