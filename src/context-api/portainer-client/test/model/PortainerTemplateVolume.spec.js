...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerTemplateVolume', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerTemplateVolume();
      });

      it('should create an instance of PortainerTemplateVolume', function() {
        // TODO: update the code to test PortainerTemplateVolume
        expect(instance).to.be.a(PortainerCeApi.PortainerTemplateVolume);
      });

      it('should have the property bind (base name: "bind")', function() {
        // TODO: update the code to test the property bind
        expect(instance).to.have.property('bind');
        // expect(instance.bind).to.be(expectedValueLiteral);
      });
