...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FilesystemDirEntry', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.FilesystemDirEntry();
      });

      it('should create an instance of FilesystemDirEntry', function() {
        // TODO: update the code to test FilesystemDirEntry
        expect(instance).to.be.a(PortainerCeApi.FilesystemDirEntry);
      });
      ...
      it('should have the property isFile (base name: "isFile")', function() {
        // TODO: update the code to test the property isFile
        expect(instance).to.have.property('isFile');
        // expect(instance.isFile).to.be(expectedValueLiteral);
      });
