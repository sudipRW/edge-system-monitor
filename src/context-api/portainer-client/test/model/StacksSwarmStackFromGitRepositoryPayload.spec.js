...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StacksSwarmStackFromGitRepositoryPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.StacksSwarmStackFromGitRepositoryPayload();
      });

      it('should create an instance of StacksSwarmStackFromGitRepositoryPayload', function() {
        // TODO: update the code to test StacksSwarmStackFromGitRepositoryPayload
        expect(instance).to.be.a(PortainerCeApi.StacksSwarmStackFromGitRepositoryPayload);
      });
