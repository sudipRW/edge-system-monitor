...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeammembershipsTeamMembershipUpdatePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.TeammembershipsTeamMembershipUpdatePayload();
      });

      it('should create an instance of TeammembershipsTeamMembershipUpdatePayload', function() {
        // TODO: update the code to test TeammembershipsTeamMembershipUpdatePayload
        expect(instance).to.be.a(PortainerCeApi.TeammembershipsTeamMembershipUpdatePayload);
      });
