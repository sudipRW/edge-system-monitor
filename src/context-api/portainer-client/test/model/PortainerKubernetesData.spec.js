...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerKubernetesData', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerKubernetesData();
      });

      it('should create an instance of PortainerKubernetesData', function() {
        // TODO: update the code to test PortainerKubernetesData
        expect(instance).to.be.a(PortainerCeApi.PortainerKubernetesData);
      });
