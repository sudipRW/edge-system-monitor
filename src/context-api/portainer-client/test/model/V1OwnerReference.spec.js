...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1OwnerReference', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.V1OwnerReference();
      });

      it('should create an instance of V1OwnerReference', function() {
        // TODO: update the code to test V1OwnerReference
        expect(instance).to.be.a(PortainerCeApi.V1OwnerReference);
      });
      ...
      it('should have the property blockOwnerDeletion (base name: "blockOwnerDeletion")', function() {
        // TODO: update the code to test the property blockOwnerDeletion
        expect(instance).to.have.property('blockOwnerDeletion');
        // expect(instance.blockOwnerDeletion).to.be(expectedValueLiteral);
      });
