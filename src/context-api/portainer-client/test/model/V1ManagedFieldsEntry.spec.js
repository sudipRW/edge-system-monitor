...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ManagedFieldsEntry', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.V1ManagedFieldsEntry();
      });

      it('should create an instance of V1ManagedFieldsEntry', function() {
        // TODO: update the code to test V1ManagedFieldsEntry
        expect(instance).to.be.a(PortainerCeApi.V1ManagedFieldsEntry);
      });
      ...
      it('should have the property fieldsType (base name: "fieldsType")', function() {
        // TODO: update the code to test the property fieldsType
        expect(instance).to.have.property('fieldsType');
        // expect(instance.fieldsType).to.be(expectedValueLiteral);
      });

      it('should have the property fieldsV1 (base name: "fieldsV1")', function() {
        // TODO: update the code to test the property fieldsV1
        expect(instance).to.have.property('fieldsV1');
        // expect(instance.fieldsV1).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property subresource (base name: "subresource")', function() {
        // TODO: update the code to test the property subresource
        expect(instance).to.have.property('subresource');
        // expect(instance.subresource).to.be(expectedValueLiteral);
      });
