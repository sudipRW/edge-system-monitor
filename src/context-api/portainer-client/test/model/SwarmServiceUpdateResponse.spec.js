...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SwarmServiceUpdateResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.SwarmServiceUpdateResponse();
      });

      it('should create an instance of SwarmServiceUpdateResponse', function() {
        // TODO: update the code to test SwarmServiceUpdateResponse
        expect(instance).to.be.a(PortainerCeApi.SwarmServiceUpdateResponse);
      });
