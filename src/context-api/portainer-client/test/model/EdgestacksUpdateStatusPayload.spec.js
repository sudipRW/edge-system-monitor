...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgestacksUpdateStatusPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.EdgestacksUpdateStatusPayload();
      });

      it('should create an instance of EdgestacksUpdateStatusPayload', function() {
        // TODO: update the code to test EdgestacksUpdateStatusPayload
        expect(instance).to.be.a(PortainerCeApi.EdgestacksUpdateStatusPayload);
      });
