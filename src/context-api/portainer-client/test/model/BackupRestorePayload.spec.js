...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BackupRestorePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.BackupRestorePayload();
      });

      it('should create an instance of BackupRestorePayload', function() {
        // TODO: update the code to test BackupRestorePayload
        expect(instance).to.be.a(PortainerCeApi.BackupRestorePayload);
      });
