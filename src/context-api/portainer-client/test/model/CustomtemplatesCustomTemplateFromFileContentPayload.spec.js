...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomtemplatesCustomTemplateFromFileContentPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.CustomtemplatesCustomTemplateFromFileContentPayload();
      });

      it('should create an instance of CustomtemplatesCustomTemplateFromFileContentPayload', function() {
        // TODO: update the code to test CustomtemplatesCustomTemplateFromFileContentPayload
        expect(instance).to.be.a(PortainerCeApi.CustomtemplatesCustomTemplateFromFileContentPayload);
      });
