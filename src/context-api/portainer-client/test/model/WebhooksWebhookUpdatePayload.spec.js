...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebhooksWebhookUpdatePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.WebhooksWebhookUpdatePayload();
      });

      it('should create an instance of WebhooksWebhookUpdatePayload', function() {
        // TODO: update the code to test WebhooksWebhookUpdatePayload
        expect(instance).to.be.a(PortainerCeApi.WebhooksWebhookUpdatePayload);
      });
