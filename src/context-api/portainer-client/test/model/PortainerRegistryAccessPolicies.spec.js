...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerRegistryAccessPolicies', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerRegistryAccessPolicies();
      });

      it('should create an instance of PortainerRegistryAccessPolicies', function() {
        // TODO: update the code to test PortainerRegistryAccessPolicies
        expect(instance).to.be.a(PortainerCeApi.PortainerRegistryAccessPolicies);
      });

      it('should have the property namespaces (base name: "Namespaces")', function() {
        // TODO: update the code to test the property namespaces
        expect(instance).to.have.property('namespaces');
        // expect(instance.namespaces).to.be(expectedValueLiteral);
      });
