...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StacksStackMigratePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.StacksStackMigratePayload();
      });

      it('should create an instance of StacksStackMigratePayload', function() {
        // TODO: update the code to test StacksStackMigratePayload
        expect(instance).to.be.a(PortainerCeApi.StacksStackMigratePayload);
      });
