...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesK8sServiceIngress', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.KubernetesK8sServiceIngress();
      });

      it('should create an instance of KubernetesK8sServiceIngress', function() {
        // TODO: update the code to test KubernetesK8sServiceIngress
        expect(instance).to.be.a(PortainerCeApi.KubernetesK8sServiceIngress);
      });
