...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesK8sResourceQuota', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.KubernetesK8sResourceQuota();
      });

      it('should create an instance of KubernetesK8sResourceQuota', function() {
        // TODO: update the code to test KubernetesK8sResourceQuota
        expect(instance).to.be.a(PortainerCeApi.KubernetesK8sResourceQuota);
      });
