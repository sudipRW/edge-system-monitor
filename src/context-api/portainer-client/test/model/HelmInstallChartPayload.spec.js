...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HelmInstallChartPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.HelmInstallChartPayload();
      });

      it('should create an instance of HelmInstallChartPayload', function() {
        // TODO: update the code to test HelmInstallChartPayload
        expect(instance).to.be.a(PortainerCeApi.HelmInstallChartPayload);
      });
      ...
      it('should have the property repo (base name: "repo")', function() {
        // TODO: update the code to test the property repo
        expect(instance).to.have.property('repo');
        // expect(instance.repo).to.be(expectedValueLiteral);
      });
