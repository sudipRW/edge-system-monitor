...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerTLSConfiguration', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerTLSConfiguration();
      });

      it('should create an instance of PortainerTLSConfiguration', function() {
        // TODO: update the code to test PortainerTLSConfiguration
        expect(instance).to.be.a(PortainerCeApi.PortainerTLSConfiguration);
      });
