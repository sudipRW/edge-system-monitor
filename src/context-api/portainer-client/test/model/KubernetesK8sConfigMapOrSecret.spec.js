...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesK8sConfigMapOrSecret', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.KubernetesK8sConfigMapOrSecret();
      });

      it('should create an instance of KubernetesK8sConfigMapOrSecret', function() {
        // TODO: update the code to test KubernetesK8sConfigMapOrSecret
        expect(instance).to.be.a(PortainerCeApi.KubernetesK8sConfigMapOrSecret);
      });
