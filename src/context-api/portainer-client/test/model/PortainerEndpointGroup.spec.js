...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerEndpointGroup', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerEndpointGroup();
      });

      it('should create an instance of PortainerEndpointGroup', function() {
        // TODO: update the code to test PortainerEndpointGroup
        expect(instance).to.be.a(PortainerCeApi.PortainerEndpointGroup);
      });
