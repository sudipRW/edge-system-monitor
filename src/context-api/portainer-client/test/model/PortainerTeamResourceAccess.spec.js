...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerTeamResourceAccess', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerTeamResourceAccess();
      });

      it('should create an instance of PortainerTeamResourceAccess', function() {
        // TODO: update the code to test PortainerTeamResourceAccess
        expect(instance).to.be.a(PortainerCeApi.PortainerTeamResourceAccess);
      });
