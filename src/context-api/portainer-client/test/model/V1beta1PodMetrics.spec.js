...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1beta1PodMetrics', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.V1beta1PodMetrics();
      });

      it('should create an instance of V1beta1PodMetrics', function() {
        // TODO: update the code to test V1beta1PodMetrics
        expect(instance).to.be.a(PortainerCeApi.V1beta1PodMetrics);
      });
