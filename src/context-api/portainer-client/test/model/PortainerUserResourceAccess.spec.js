...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerUserResourceAccess', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerUserResourceAccess();
      });

      it('should create an instance of PortainerUserResourceAccess', function() {
        // TODO: update the code to test PortainerUserResourceAccess
        expect(instance).to.be.a(PortainerCeApi.PortainerUserResourceAccess);
      });
