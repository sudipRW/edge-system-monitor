...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemSystemInfoResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.SystemSystemInfoResponse();
      });

      it('should create an instance of SystemSystemInfoResponse', function() {
        // TODO: update the code to test SystemSystemInfoResponse
        expect(instance).to.be.a(PortainerCeApi.SystemSystemInfoResponse);
      });
      ...
      it('should have the property edgeAgents (base name: "edgeAgents")', function() {
        // TODO: update the code to test the property edgeAgents
        expect(instance).to.have.property('edgeAgents');
        // expect(instance.edgeAgents).to.be(expectedValueLiteral);
      });
