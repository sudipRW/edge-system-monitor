...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerAccessPolicy', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerAccessPolicy();
      });

      it('should create an instance of PortainerAccessPolicy', function() {
        // TODO: update the code to test PortainerAccessPolicy
        expect(instance).to.be.a(PortainerCeApi.PortainerAccessPolicy);
      });
