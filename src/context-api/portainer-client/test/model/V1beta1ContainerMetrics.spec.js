...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1beta1ContainerMetrics', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.V1beta1ContainerMetrics();
      });

      it('should create an instance of V1beta1ContainerMetrics', function() {
        // TODO: update the code to test V1beta1ContainerMetrics
        expect(instance).to.be.a(PortainerCeApi.V1beta1ContainerMetrics);
      });
