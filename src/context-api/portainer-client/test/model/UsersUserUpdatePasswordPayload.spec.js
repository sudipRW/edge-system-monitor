...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UsersUserUpdatePasswordPayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.UsersUserUpdatePasswordPayload();
      });

      it('should create an instance of UsersUserUpdatePasswordPayload', function() {
        // TODO: update the code to test UsersUserUpdatePasswordPayload
        expect(instance).to.be.a(PortainerCeApi.UsersUserUpdatePasswordPayload);
      });
