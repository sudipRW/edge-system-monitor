...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebhooksWebhookCreatePayload', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.WebhooksWebhookCreatePayload();
      });

      it('should create an instance of WebhooksWebhookCreatePayload', function() {
        // TODO: update the code to test WebhooksWebhookCreatePayload
        expect(instance).to.be.a(PortainerCeApi.WebhooksWebhookCreatePayload);
      });
      ...
      it('should have the property webhookType (base name: "webhookType")', function() {
        // TODO: update the code to test the property webhookType
        expect(instance).to.have.property('webhookType');
        // expect(instance.webhookType).to.be(expectedValueLiteral);
      });
