...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerK8sNodeLimits', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerK8sNodeLimits();
      });

      it('should create an instance of PortainerK8sNodeLimits', function() {
        // TODO: update the code to test PortainerK8sNodeLimits
        expect(instance).to.be.a(PortainerCeApi.PortainerK8sNodeLimits);
      });
