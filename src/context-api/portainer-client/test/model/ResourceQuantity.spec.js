...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResourceQuantity', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ResourceQuantity();
      });

      it('should create an instance of ResourceQuantity', function() {
        // TODO: update the code to test ResourceQuantity
        expect(instance).to.be.a(PortainerCeApi.ResourceQuantity);
      });
