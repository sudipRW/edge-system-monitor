...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReleaseRelease', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.ReleaseRelease();
      });

      it('should create an instance of ReleaseRelease', function() {
        // TODO: update the code to test ReleaseRelease
        expect(instance).to.be.a(PortainerCeApi.ReleaseRelease);
      });
      ...
      it('should have the property hooks (base name: "hooks")', function() {
        // TODO: update the code to test the property hooks
        expect(instance).to.have.property('hooks');
        // expect(instance.hooks).to.be(expectedValueLiteral);
      });
