...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerK8sNamespaceInfo', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerK8sNamespaceInfo();
      });

      it('should create an instance of PortainerK8sNamespaceInfo', function() {
        // TODO: update the code to test PortainerK8sNamespaceInfo
        expect(instance).to.be.a(PortainerCeApi.PortainerK8sNamespaceInfo);
      });
