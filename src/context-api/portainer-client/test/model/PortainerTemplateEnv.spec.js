...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortainerTemplateEnv', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.PortainerTemplateEnv();
      });

      it('should create an instance of PortainerTemplateEnv', function() {
        // TODO: update the code to test PortainerTemplateEnv
        expect(instance).to.be.a(PortainerCeApi.PortainerTemplateEnv);
      });
      ...
      it('should have the property select (base name: "select")', function() {
        // TODO: update the code to test the property select
        expect(instance).to.have.property('select');
        // expect(instance.select).to.be(expectedValueLiteral);
      });
