...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KubernetesK8sApplication', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.KubernetesK8sApplication();
      });

      it('should create an instance of KubernetesK8sApplication', function() {
        // TODO: update the code to test KubernetesK8sApplication
        expect(instance).to.be.a(PortainerCeApi.KubernetesK8sApplication);
      });
