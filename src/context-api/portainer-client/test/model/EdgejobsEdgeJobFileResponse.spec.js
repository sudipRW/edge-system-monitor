...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EdgejobsEdgeJobFileResponse', function() {
      beforeEach(function() {
        instance = new PortainerCeApi.EdgejobsEdgeJobFileResponse();
      });

      it('should create an instance of EdgejobsEdgeJobFileResponse', function() {
        // TODO: update the code to test EdgejobsEdgeJobFileResponse
        expect(instance).to.be.a(PortainerCeApi.EdgejobsEdgeJobFileResponse);
      });
