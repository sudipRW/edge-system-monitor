...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EdgeStackPayload'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EdgeStackPayload'));
  } else {
    // Browser globals (root is window)
    if (!root.PortainerCeApi) {
      root.PortainerCeApi = {};
    }
    root.PortainerCeApi.EdgeApi = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.EdgeStackPayload);
  }
}(this, function(ApiClient, EdgeStackPayload) {
  'use strict';
  ...
  /**
   * Constructs a new EdgeApi. 
   * @alias module:api/EdgeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/EdgeApi~endpointsIdEdgeJobsJobIDLogsPostCallback
     ...
     * @param {module:api/EdgeApi~endpointsIdEdgeJobsJobIDLogsPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/EdgeApi~endpointsIdEdgeStacksStackIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/EdgeApi~endpointsIdEdgeStacksStackIdGetCallback} callback The callback function, accepting three arguments: error, data, response
