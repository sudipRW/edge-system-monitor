...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerCeApi.StacksStackGitUpdatePayload = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.PortainerAutoUpdateSettings, root.PortainerCeApi.PortainerPair);
  }
}(this, function(ApiClient, PortainerAutoUpdateSettings, PortainerPair) {
  'use strict';

  /**
   * The StacksStackGitUpdatePayload model module.
   * @module model/StacksStackGitUpdatePayload
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>StacksStackGitUpdatePayload</code>.
   * @alias module:model/StacksStackGitUpdatePayload
   * @class
   */
  ...
  /**
   * Constructs a <code>StacksStackGitUpdatePayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StacksStackGitUpdatePayload} obj Optional instance to populate.
   * @return {module:model/StacksStackGitUpdatePayload} The populated <code>StacksStackGitUpdatePayload</code> instance.
   */
