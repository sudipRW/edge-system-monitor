...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1beta1PodMetrics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1beta1PodMetrics'));
  } else {
    // Browser globals (root is window)
    if (!root.PortainerCeApi) {
      root.PortainerCeApi = {};
    }
    root.PortainerCeApi.V1beta1PodMetricsList = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.V1beta1PodMetrics);
  }
}(this, function(ApiClient, V1beta1PodMetrics) {
  'use strict';

  /**
   * The V1beta1PodMetricsList model module.
   * @module model/V1beta1PodMetricsList
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>V1beta1PodMetricsList</code>.
   * @alias module:model/V1beta1PodMetricsList
   * @class
   */
  ...
  /**
   * Constructs a <code>V1beta1PodMetricsList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V1beta1PodMetricsList} obj Optional instance to populate.
   * @return {module:model/V1beta1PodMetricsList} The populated <code>V1beta1PodMetricsList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [V1beta1PodMetrics]);
  ...
  /**
   * List of pod metrics.
   * @member {Array.<module:model/V1beta1PodMetrics>} items
   */
