...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Duration', 'model/V1ManagedFieldsEntry', 'model/V1OwnerReference', 'model/V1beta1ContainerMetrics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1Duration'), require('./V1ManagedFieldsEntry'), require('./V1OwnerReference'), require('./V1beta1ContainerMetrics'));
  } else {
    // Browser globals (root is window)
    if (!root.PortainerCeApi) {
      root.PortainerCeApi = {};
    }
    root.PortainerCeApi.V1beta1PodMetrics = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.V1Duration, root.PortainerCeApi.V1ManagedFieldsEntry, root.PortainerCeApi.V1OwnerReference, root.PortainerCeApi.V1beta1ContainerMetrics);
  }
}(this, function(ApiClient, V1Duration, V1ManagedFieldsEntry, V1OwnerReference, V1beta1ContainerMetrics) {
  'use strict';

  /**
   * The V1beta1PodMetrics model module.
   * @module model/V1beta1PodMetrics
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>V1beta1PodMetrics</code>.
   * @alias module:model/V1beta1PodMetrics
   * @class
   */
  ...
  /**
   * Constructs a <code>V1beta1PodMetrics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V1beta1PodMetrics} obj Optional instance to populate.
   * @return {module:model/V1beta1PodMetrics} The populated <code>V1beta1PodMetrics</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('containers'))
        obj.containers = ApiClient.convertToType(data['containers'], [V1beta1ContainerMetrics]);
   ...
   * @member {Array.<module:model/V1beta1ContainerMetrics>} containers
   */
