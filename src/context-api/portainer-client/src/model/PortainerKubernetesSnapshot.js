...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerCeApi.PortainerKubernetesSnapshot = factory(root.PortainerCeApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PortainerKubernetesSnapshot model module.
   * @module model/PortainerKubernetesSnapshot
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>PortainerKubernetesSnapshot</code>.
   * @alias module:model/PortainerKubernetesSnapshot
   * @class
   */
  ...
  /**
   * Constructs a <code>PortainerKubernetesSnapshot</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortainerKubernetesSnapshot} obj Optional instance to populate.
   * @return {module:model/PortainerKubernetesSnapshot} The populated <code>PortainerKubernetesSnapshot</code> instance.
   */
