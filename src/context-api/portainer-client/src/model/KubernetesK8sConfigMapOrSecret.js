...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerCeApi.KubernetesK8sConfigMapOrSecret = factory(root.PortainerCeApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The KubernetesK8sConfigMapOrSecret model module.
   * @module model/KubernetesK8sConfigMapOrSecret
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>KubernetesK8sConfigMapOrSecret</code>.
   * @alias module:model/KubernetesK8sConfigMapOrSecret
   * @class
   */
  ...
  /**
   * Constructs a <code>KubernetesK8sConfigMapOrSecret</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KubernetesK8sConfigMapOrSecret} obj Optional instance to populate.
   * @return {module:model/KubernetesK8sConfigMapOrSecret} The populated <code>KubernetesK8sConfigMapOrSecret</code> instance.
   */
