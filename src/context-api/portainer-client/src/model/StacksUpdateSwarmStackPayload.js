...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerCeApi.StacksUpdateSwarmStackPayload = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.PortainerPair);
  }
}(this, function(ApiClient, PortainerPair) {
  'use strict';

  /**
   * The StacksUpdateSwarmStackPayload model module.
   * @module model/StacksUpdateSwarmStackPayload
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>StacksUpdateSwarmStackPayload</code>.
   * @alias module:model/StacksUpdateSwarmStackPayload
   * @class
   */
  ...
  /**
   * Constructs a <code>StacksUpdateSwarmStackPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StacksUpdateSwarmStackPayload} obj Optional instance to populate.
   * @return {module:model/StacksUpdateSwarmStackPayload} The populated <code>StacksUpdateSwarmStackPayload</code> instance.
   */
