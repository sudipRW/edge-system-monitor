...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerCeApi.StacksComposeStackFromGitRepositoryPayload = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.PortainerAutoUpdateSettings, root.PortainerCeApi.PortainerPair);
  }
}(this, function(ApiClient, PortainerAutoUpdateSettings, PortainerPair) {
  'use strict';

  /**
   * The StacksComposeStackFromGitRepositoryPayload model module.
   * @module model/StacksComposeStackFromGitRepositoryPayload
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>StacksComposeStackFromGitRepositoryPayload</code>.
   * @alias module:model/StacksComposeStackFromGitRepositoryPayload
   * @class
   * @param name {String} Name of the stack
   * @param repositoryURL {String} URL of a Git repository hosting the Stack file
   */
  var exports = function(name, repositoryURL) {
    this.name = name;
    this.repositoryURL = repositoryURL;
  };

  /**
   * Constructs a <code>StacksComposeStackFromGitRepositoryPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StacksComposeStackFromGitRepositoryPayload} obj Optional instance to populate.
   * @return {module:model/StacksComposeStackFromGitRepositoryPayload} The populated <code>StacksComposeStackFromGitRepositoryPayload</code> instance.
   */
