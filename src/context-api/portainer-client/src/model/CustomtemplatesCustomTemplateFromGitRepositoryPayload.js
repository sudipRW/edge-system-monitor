...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerCeApi.CustomtemplatesCustomTemplateFromGitRepositoryPayload = factory(root.PortainerCeApi.ApiClient, root.PortainerCeApi.PortainerCustomTemplateVariableDefinition);
  }
}(this, function(ApiClient, PortainerCustomTemplateVariableDefinition) {
  'use strict';

  /**
   * The CustomtemplatesCustomTemplateFromGitRepositoryPayload model module.
   * @module model/CustomtemplatesCustomTemplateFromGitRepositoryPayload
   * @version 2.21.3
   */

  /**
   * Constructs a new <code>CustomtemplatesCustomTemplateFromGitRepositoryPayload</code>.
   * @alias module:model/CustomtemplatesCustomTemplateFromGitRepositoryPayload
   * @class
   ...
   */
  var exports = function(description, repositoryURL, title, type) {
  ...
  /**
   * Constructs a <code>CustomtemplatesCustomTemplateFromGitRepositoryPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomtemplatesCustomTemplateFromGitRepositoryPayload} obj Optional instance to populate.
   * @return {module:model/CustomtemplatesCustomTemplateFromGitRepositoryPayload} The populated <code>CustomtemplatesCustomTemplateFromGitRepositoryPayload</code> instance.
   */
